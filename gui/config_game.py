...
class ConfigGameDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.white_player_combo.addItems(["Human", "Low elo bot", "Base bot", "Minimax", "Stockfish"])
        ...
        self.black_player_combo.addItems(["Human", "Low elo bot", "Base bot", "Minimax", "Stockfish"])
