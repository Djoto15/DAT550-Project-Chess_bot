...
<br>
You can choose the white player and the black player. If it is a two bots game or one bot playing against yourself, you need to launch the game manually using the "Launch game" command in the menu bar at the top of the window.<br><br>
